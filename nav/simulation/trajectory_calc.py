...
class rocket:
    ...
    def update_state(self):
        ...
        temp_phi = math.acos((self.position[FIRST_ORDER][Z]/(self.velocity+0.000001)))
        self.phi[ZEROTH_ORDER] = temp_phi
...
test_rocket = rocket(0, 0, 0.0, 0.0)
test_rocket.transpose_rocket_frame_to_ground_frame()

while (test_rocket):
    if (test_rocket.overall_time < 1):
        test_rocket.thrust = 20.0
    else:
